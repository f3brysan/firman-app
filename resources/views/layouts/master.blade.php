...
<head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/vendor/fonts/materialdesignicons.css" />
    ...
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/vendor/libs/swiper/swiper.css" />

    <!-- Page CSS -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/vendor/css/pages/cards-statistics.css" />
    <link rel="stylesheet" href="{{ URL::to('/') }}/assets/vendor/css/pages/cards-analytics.css" />
    <!-- Helpers -->
...
<body>
                                        ...
                                        <ul class="list-group list-group-flush">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar me-1">
                                                            <img src="{{ URL::to('/') }}/assets/img/avatars/1.png"
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar me-1">
                                                            <img src="{{ URL::to('/') }}/assets/img/avatars/2.png"
                                                                alt class="w-px-40 h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar me-1">
                                                            <img src="{{ URL::to('/') }}/assets/img/avatars/9.png"
                                                                alt class="w-px-40 h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar me-1">
                                                            <img src="{{ URL::to('/') }}/assets/img/avatars/5.png"
                                                                alt class="w-px-40 h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar me-1">
                                                            <img src="{{ URL::to('/') }}/assets/img/avatars/6.png"
                                                                alt class="w-px-40 h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div
    ...
    <script src="{{ URL::to('/') }}/assets/vendor/libs/swiper/swiper.js"></script>
